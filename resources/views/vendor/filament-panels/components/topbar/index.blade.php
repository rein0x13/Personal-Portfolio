...
<div
    ...
    <nav class="flex h-16 items-center gap-x-4  px-4 shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 md:px-6 lg:px-8"
        style=" background-color: #09090baa !important;
